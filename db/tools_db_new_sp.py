...
class DbNewSpTools(BaseDb):
    ...
    async def add_sd_adGroup_Targeting(self, market,adGroupId,bid,expression_type,state,expression,targetingType,targetingState, update_time,targetId,user='test'):
        try:
